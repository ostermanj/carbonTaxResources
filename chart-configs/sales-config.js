  ...
  /*  var elementWatcher = scrollmonitor.create(this.Highchart.renderTo);
   ...
   //     animate.call(this);
    ...
    function animate(){
        ...
        var togglableElements = this.Highchart.renderTo.querySelectorAll('.highcharts-title, .highcharts-subtitle, .highcharts-yaxis-grid, .highcharts-axis, .highcharts-axis-labels, .highcharts-legend, .highcharts-credits, .highcharts-note');
